  ...
  return (
    <TouchableOpacity style={styles.row} onPress={() => onPress?.(item)} activeOpacity={0.85}>
      <View style={styles.thumbWrap}>
        <AppImage path={item.product_image_path} style={styles.thumb} placeholderText="📦" useThumb />
      </View>
      <View style={{ flex: 1 }}>
...
function ServiceListingRow({ item, onPress, onEdit, onDelete }) {
  return (
    <TouchableOpacity style={styles.row} onPress={() => onPress?.(item)} activeOpacity={0.85}>
      <View style={styles.thumbWrap}>
        <AppImage path={item.service_logo_path} style={styles.thumb} placeholderText="🏢" useThumb />
      </View>
      <View style={{ flex: 1 }}>
        <View style={styles.rowTop}>
